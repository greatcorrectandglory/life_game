const createInitialState = () => ({
  ...
  // New Systems State
  karma: { good: 0, evil: 0, balance: 0, log: [] }, // 因果池
  relationships: {}, // NPC ID -> { affinity: number, unlocked: boolean }
  activeVentures: [], //List of { id, progress, duration }
  perks: [], // List of active perk IDs
  flowState: "normal" // normal, flow, burnout, overload
});
